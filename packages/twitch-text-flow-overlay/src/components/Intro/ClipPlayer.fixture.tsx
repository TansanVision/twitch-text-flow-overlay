...
export default () => {
    const [showClipPlayer, setShowClipPlayer] = useState(true);
    const clips: Clip[] = [{
    ...
    return <div style={{ width: '100%', height: '100%' }}><ClipPlayer clips={clips} onFinished={() => setShowClipPlayer(false)} /></div>;
}
