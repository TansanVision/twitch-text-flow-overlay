...
export default () => {
    const raiderName = "TansanVision";
    const displayName = "TansanVision";
    const iconUrl = "https://static-cdn.jtvnw.net/jtv_user_pictures/afdc1d67-8c1f-494b-ae22-fbfbb015a081-profile_image-70x70.png";
    const viewerCount = 5;
